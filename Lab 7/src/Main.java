...
public class Main {
	...
	public static void testArea(){
		...
		if(r1.area()==12 && r1.equals(new Rect(3,4))){
			System.out.println("6. Area function is CORRECT.");
		}else{
	...
	public static void testToString(){
		...
		if(s1.equals(s3) && s2.equals(s4)){
			System.out.println("7. toString function is CORRECT.");
		}else{
			System.out.println("toString function is incorrect.");
			System.out.println("check that spaces and returns are correct");
			System.out.println("W=3, H=4");
